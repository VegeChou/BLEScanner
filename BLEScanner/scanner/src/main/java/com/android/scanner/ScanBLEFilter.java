...
public final class ScanBLEFilter implements Parcelable {
    ...
    private static final ScanBLEFilter EMPTY = new ScanBLEFilter.Builder().build() ;


    private ScanBLEFilter(String name, String deviceAddress, ParcelUuid uuid,
    ...
    /**
     * A {@link Creator} to create {@link ScanBLEFilter} from parcel.
     */
    public static final Creator<ScanBLEFilter>
            CREATOR = new Creator<ScanBLEFilter>() {

        @Override
        public ScanBLEFilter[] newArray(int size) {
            return new ScanBLEFilter[size];
        }

        @Override
        public ScanBLEFilter createFromParcel(Parcel in) {
     ...
     */
    public boolean matches(ScanBLEResult scanResult) {
        if (scanResult == null) {
            return false;
        }
        ...
        ScanBLERecord scanRecord = scanResult.getScanRecord();
    ...
    public String toString() {
        return "BluetoothLeScanBLEFilter [mDeviceName=" + mDeviceName + ", mDeviceAddress="
                + mDeviceAddress
    ...
    public boolean equals(Object obj) {
        ...
        ScanBLEFilter other = (ScanBLEFilter) obj;
    ...
    /**
     * Checks if the ScanBLEFilter is empty
     * @hide
     */
    ...
    /**
     * Builder class for {@link ScanBLEFilter}.
     */
    public static final class Builder {
        ...
        /**
         * Build {@link ScanBLEFilter}.
         *
         * @throws IllegalArgumentException If the filter cannot be built.
         */
        public ScanBLEFilter build() {
            return new ScanBLEFilter(mDeviceName, mDeviceAddress,
